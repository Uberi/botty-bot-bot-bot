...
export SLACK_AUTHENTICATION_REDIRECT_URL="http://localhost:5000/authorize" # should be of the form "(CURRENT SERVER'S HOST)/authorize", and must be publicly accessible from the internet
