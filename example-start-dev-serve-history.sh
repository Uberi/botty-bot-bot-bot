...
export SLACK_AUTHENTICATION_REDIRECT_URL="http://localhost:5000/authenticate" # should be of the form "(CURRENT SERVER'S HOST)/authenticate", and must be publicly accessible from the internet
